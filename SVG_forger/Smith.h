...
private:
	...
	void recSplit(vector<string> & tokens, string clue, int i, int j, int lines, int cuts, double len, string & bestClue, int & bestLines, int & bestCuts, double & bestSigma);

public:

	int setInd = 0, squareInd = 1, arrowInd = 2;
	double setRotation = 0, squareRotation = 0, setSizeCoefX = 1, setSizeCoefY = 1, squareSizeCoefX = 1.1, squareSizeCoefY = 1.1, arrowSizeCoefX = 1, arrowSizeCoefY = 1;
